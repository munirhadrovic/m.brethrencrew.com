...
<html>
	<head>
		...
		<title>Brethren - Coastal Lifestyle Company</title>
	...
	<body>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<a class="dugme ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">BRETHREN HOME</a>
				...
				<div data-role="collapsible" data-theme="<?php echo $theme ?>" data-content-theme="<?php echo $theme ?>" data-iconpos="right" data-collapsed-icon="carat-d" data-expanded-icon="carat-u">
				   <h3>PRODUCTS</h3>
				   <a class="manja-dugmad-u-listama ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">MENS APPAREL</a>
				   <a class="manja-dugmad-u-listama ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">WOMENS APPAREL</a>
				...
				<a class="dugme ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">MEDIA</a>
				<a class="dugme ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">ABOUT US</a>
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">BRETHREN HOME</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">PRODUCTS</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">MEDIA</a></li>
