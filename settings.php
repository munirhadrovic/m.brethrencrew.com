<?php
	$adresa="4584 Enterprise Ave. Suite 5 Naples, FL 34104"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2397771118;// Broj koji se poziva na dugme CALL US
